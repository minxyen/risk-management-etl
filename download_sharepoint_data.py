...
def download_sharepoint_data(ICF_USERNAME, ICF_PASSWORD, SP_SITE_URL, SP_FOLDER_URL, WILDCARD_FILENAME):
    ...
    print('All files in the folder:', file_names)
    ...
    print('Target file names based on wildcard search:', target_file_name)
    ...
    print('Download data to local:', download_path)
...
output_file_name = download_sharepoint_data(ICF_USERNAME, ICF_PASSWORD, SP_SITE_URL, SP_FOLDER_URL, WILDCARD_FILENAME)
